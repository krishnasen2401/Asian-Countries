...
import com.lingamworks.asiancountries.Database.typeconverters;
...
public class Country {
    ...
    @Ignore
    private String cioc;
public Country(String name,String capital,String region,String subregion,Integer population,List<String> borders,String numericCode,String flag){
    this.name=name;
